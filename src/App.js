...
class App extends React.Component {
  ...
  maxDigitWarning() {
    this.setState({
      currentVal: "Digit Limit Crossed",
      preVal: this.state.currentVal,
    });
    setTimeout(() => this.setState({ currentVal: this.state.preVal }), 1000);
  }
  ...
  handleOperators(e) {
    if (!this.state.currentVal.includes("Limit")) {
      ...
      if (evaluated) {
        ...
        this.setState({
          formula:
            (endsWithNegativeSign.test(formula + value) ? formula : preVal) +
            value,
        });
      } else if (value !== "-") {
        this.setState({
    ...
    return (
      <div className="container">
        ...
        <div className="calculator">
          ...
          <Output currentVal={this.state.currentVal} />
          <Buttons
